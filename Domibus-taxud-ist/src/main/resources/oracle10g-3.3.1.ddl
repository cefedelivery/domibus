...
CREATE TABLE tb_part_info (ID_PK NUMBER(10) NOT NULL, BINARY_DATA BLOB, DESCRIPTION_LANG VARCHAR2(255), DESCRIPTION_VALUE VARCHAR2(255), HREF VARCHAR2(255), IN_BODY NUMBER(1), SCHEMA_LOCATION VARCHAR2(255), SCHEMA_NAMESPACE VARCHAR2(255), SCHEMA_VERSION VARCHAR2(255), PAYLOADINFO_ID NUMBER(10), CONSTRAINT PK_TB_PART_INFO PRIMARY KEY (ID_PK)) LOB(BINARY_DATA) STORE AS SECUREFILE;
