...
INSERT INTO "TB_PARTY" VALUES (2,'http://localhost:8180/domibus/services/msh','blue_gw',NULL,NULL,1);

INSERT INTO "TB_CONFIGURATION" VALUES (1,1,1);

INSERT INTO "TB_PARTY_ID_TYPE" ("ID_PK","NAME","VALUE","FK_BUSINESSPROCESS")
VALUES (1,'partyTypeEmpty','',1);

INSERT INTO "TB_PARTY_ID_TYPE" ("ID_PK","NAME","VALUE","FK_BUSINESSPROCESS")
VALUES (2,'partyTypeEmpty','',1);

INSERT INTO "TB_PARTY_IDENTIFIER" ("ID_PK","PARTY_ID","FK_PARTY_ID_TYPE","FK_PARTY")
VALUES (1,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-red',1,1);

INSERT INTO "TB_PARTY_IDENTIFIER" ("ID_PK","PARTY_ID","FK_PARTY_ID_TYPE","FK_PARTY")
VALUES (2,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-blue',1,2);
...
INSERT INTO "TB_MESSAGE_INFO" ("ID_PK","MESSAGE_ID","REF_TO_MESSAGE_ID","TIMESTAMP") VALUES (4,'88a1d578-0cc7-41fb-9f35-86a5b2769a14@domibus.eu',NULL,'2016-02-11 16:29:44');
...
VALUES (1,NULL,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-blue',NULL,1);
INSERT INTO "TB_PARTY_ID" ("ID_PK","TYPE","VALUE","TO_ID","FROM_ID")
VALUES (2,NULL,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-red',1,NULL);

INSERT INTO "TB_PARTY_ID" ("ID_PK","TYPE","VALUE","TO_ID","FROM_ID")
VALUES (3,NULL,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-blue',NULL,2);
INSERT INTO "TB_PARTY_ID" ("ID_PK","TYPE","VALUE","TO_ID","FROM_ID")
VALUES (4,NULL,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-red',2,NULL);

INSERT INTO "TB_PARTY_ID" ("ID_PK","TYPE","VALUE","TO_ID","FROM_ID")
VALUES (5,NULL,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-blue',NULL,3);
INSERT INTO "TB_PARTY_ID" ("ID_PK","TYPE","VALUE","TO_ID","FROM_ID")
VALUES (6,NULL,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-red',3,NULL);

INSERT INTO "TB_PARTY_ID" ("ID_PK","TYPE","VALUE","TO_ID","FROM_ID")
VALUES (7,NULL,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-blue',NULL,4);
INSERT INTO "TB_PARTY_ID" ("ID_PK","TYPE","VALUE","TO_ID","FROM_ID")
VALUES (8,NULL,'urn:oasis:names:tc:ebcore:partyid-type:unregistered:domibus-red',4,NULL);
...
INSERT INTO "TB_MPC" VALUES (1,0x01,0x01,'http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/defaultMPC','http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/defaultMPC',0,60,1);
