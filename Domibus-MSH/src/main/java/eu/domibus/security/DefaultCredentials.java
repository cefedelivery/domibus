...
public class DefaultCredentials {
    ...
    private final static String SUPER_ADMIN = "super";
    private final static String USER_PWD = "123456"; //NOSONAR
    private final static String ADMIN_PWD = "123456"; //NOSONAR
    private final static String SUPER_ADMIN_PWD = "123456"; //NOSONAR
    ...
    static {
        ...
        DEFAULT_CREDENTIALS.put(SUPER_ADMIN, SUPER_ADMIN_PWD);
    }
