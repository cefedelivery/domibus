...
@XmlType(name = "", propOrder = "responderParty")
public class ResponderParties {

    @XmlElement(required = true)
    protected List<ResponderParty> responderParty;
     ...
     * {@link ResponderParty }
     *
     * @return a reference to the live list of responder parties
     */
    public List<ResponderParty> getResponderParty() {
        if (this.responderParty == null) {
            this.responderParty = new ArrayList<>();
        }
