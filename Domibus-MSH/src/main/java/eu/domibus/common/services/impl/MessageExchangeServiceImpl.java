...
public class MessageExchangeServiceImpl implements MessageExchangeService {
    ...
    public void initiatePullRequest() {
        ...
        String numberOfPullRequestPerMpcProp = domibusPropertyProvider.getDomainProperty(DOMIBUS_PULL_REQUEST_SEND_PER_JOB_CYCLE);
    ...
    public void verifyReceiverCertificate(final LegConfiguration legConfiguration, String receiverName) {
        ...
        if(Boolean.parseBoolean(domibusPropertyProvider.getDomainProperty(DOMIBUS_RECEIVER_CERTIFICATE_VALIDATION_ONSENDING))) {
    ...
    public void verifySenderCertificate(final LegConfiguration legConfiguration, String senderName) {
        ...
        if(Boolean.parseBoolean(domibusPropertyProvider.getDomainProperty(DOMIBUS_SENDER_CERTIFICATE_VALIDATION_ONSENDING))) {
