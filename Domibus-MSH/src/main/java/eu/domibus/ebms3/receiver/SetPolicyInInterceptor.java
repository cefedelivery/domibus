...
public class SetPolicyInInterceptor extends AbstractSoapInterceptor {
    ...
    private static final Meter requestsPerSecond = Metrics.METRIC_REGISTRY.meter(name(SetPolicyInInterceptor.class, "handleMessageMeter"));
    ...
    public void handleMessage(final SoapMessage message) throws Fault {
        ...
        try {
            ...
            LOG.businessDebug(DomibusMessageCode.BUS_SECURITY_ALGORITHM_INCOMING_USE, securityAlgorithm);
