 ...
 */
@Service
public class IncomingSourceMessageHandler implements IncomingMessageHandler {
    ...
    public SOAPMessage processMessage(SOAPMessage request, Messaging messaging) {
        ...
        try {
            responseMessage = userMessageHandlerService.handleNewSourceUserMessage(legConfiguration, pmodeKey, request, messaging, testMessage);
