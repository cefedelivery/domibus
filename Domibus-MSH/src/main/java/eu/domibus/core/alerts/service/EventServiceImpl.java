...
public class EventServiceImpl implements EventService {
    ...
    @Override
    public void enqueuePasswordExpiredEvent(IUser user, Integer maxPasswordAgeInDays) {
        EventType eventType = user.getType() == IUser.Type.CONSOLE ? EventType.PASSWORD_EXPIRED : EventType.PLUGIN_PASSWORD_EXPIRED;
        enqueuePasswordEvent(eventType, user, maxPasswordAgeInDays);
    }

    @Override
    public void enqueuePasswordImminentExpirationEvent(IUser user, Integer maxPasswordAgeInDays) {
        EventType eventType = user.getType() == IUser.Type.CONSOLE ? EventType.PASSWORD_IMMINENT_EXPIRATION : EventType.PLUGIN_PASSWORD_IMMINENT_EXPIRATION;
        enqueuePasswordEvent(eventType, user, maxPasswordAgeInDays);
    }
