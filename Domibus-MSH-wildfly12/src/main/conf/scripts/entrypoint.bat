...
CSCRIPT replace.vbs "%JBOSS_HOME%/bin/jboss-cli.xml" "<resolve-parameter-values>false</resolve-parameter-values>" "<resolve-parameter-values>true</resolve-parameter-values>"

ECHO --------------Prepare
SET > env.properties
CSCRIPT replace.vbs env.properties "\" "\\"
CSCRIPT replace.vbs env.properties "^&" "&"
