...
public class JsonSubmission {
    ...
    private final Set<JsonSubmission.Party> fromParties = new HashSet<>();
    private final Set<JsonSubmission.Party> toParties = new HashSet<>();
    //TODO: MessageProperties have an optional attribute type which is not covered yet

    private final Set<JsonSubmission.Payload> payloads = new HashSet<>();
     ...
     */
    public Set<JsonSubmission.Party> getFromParties() {
     ...
     */
    public Set<JsonSubmission.Party> getToParties() {
     ...
     */
    public Set<JsonSubmission.Payload> getPayloads() {
