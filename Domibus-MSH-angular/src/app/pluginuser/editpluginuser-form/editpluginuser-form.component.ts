...
@Component({
  ...
  templateUrl: './editpluginuser-form.component.html',
  styleUrls: ['./editpluginuser-form.component.css'],
  providers: [UserValidatorService]
})
export class EditPluginUserFormComponent {
  ...
  constructor (public dialogRef: MdDialogRef<EditPluginUserFormComponent>,
